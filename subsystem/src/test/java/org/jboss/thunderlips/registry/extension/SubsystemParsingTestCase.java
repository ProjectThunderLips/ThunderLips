...
public class SubsystemParsingTestCase extends AbstractSubsystemTest {
    ...
    public SubsystemParsingTestCase() {
        super(ThunderLipsExtension.SUBSYSTEM_NAME, new ThunderLipsExtension());
    }
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + ThunderLipsExtension.NAMESPACE + "\">" +
                        "</subsystem>";
        ...
        Assert.assertEquals(ThunderLipsExtension.SUBSYSTEM_NAME, element.getValue());
    }
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(ThunderLipsExtension.SUBSYSTEM_NAME));
    }
    ...
    public void testDescribeHandler() throws Exception {
        ...
        describeOp.get(OP_ADDR).set(
                PathAddress.pathAddress(
                        PathElement.pathElement(SUBSYSTEM, ThunderLipsExtension.SUBSYSTEM_NAME)).toModelNode());
