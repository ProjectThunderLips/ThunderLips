...
/**
 * Defines attributes and operations for the ThunderLips Subsystem
 *
 * @author Stan Silvert ssilvert@redhat.com (C) 2012 Red Hat Inc.
 */
public class ConsoleDefinition extends SimpleResourceDefinition {
    ...
    public ConsoleDefinition() {
        super(PathElement.pathElement("console"),
                ThunderLipsExtension.getResourceDescriptionResolver("console"),
                AddConsoleHandler.INSTANCE,
